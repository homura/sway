...
pub struct TypedVariableDeclaration<'de> {
    pub name: Ident,
    pub body: TypedExpression<'de>,
...
impl PartialEq for TypedVariableDeclaration<'_> {
...
impl CopyTypes for TypedVariableDeclaration<'_> {
